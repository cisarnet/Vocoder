...
#define configFILE_SYSTEM_DEMO_TASK_PRIORITY		( 1U )
#define configLWIP_TASK_PRIORITY					( 2U )
...
#define configGW_IP_ADDR0	10
#define configGW_IP_ADDR1	1
#define configGW_IP_ADDR2	2
